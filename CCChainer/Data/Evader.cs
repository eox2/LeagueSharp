...
using SharpDX;
using Geometry = CCChainer.Data.Geometry;
using Utils = CCChainer.Data.Utils;

#endregion

namespace CCChainer.Data
{
    public static class Evader
    {
            ...
            bool onlyGood = false)
        {
            ...
            var dangerPolygons = Geometry.ToPolygons(Geometry.ClipPolygons(polygonList));
