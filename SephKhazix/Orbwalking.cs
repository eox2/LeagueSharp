    ...
    public static class Orbwalking
    {
        ...
        public class Orbwalker : IDisposable
        {
            ...
            public Orbwalker(Menu attachToMenu)
            {
                ...
                _config.AddItem(
           new MenuItem("Assasination", "Assasination").SetShared().SetValue(new KeyBind('A', KeyBindType.Press)));
            ...
            /// </summary>
            /// <value><c>true</c> if the orbwalker is orbwalking by checking tmhe missiles; otherwise, <c>false</c>.</value>
            ...
            public OrbwalkingMode ActiveMode
            {
                get
                {
                    ...
                    if (_config.Item("Assasination").GetValue<KeyBind>().Active)
                    {
                        return OrbwalkingMode.Assasination;
                    }
