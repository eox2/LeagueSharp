...
namespace SephLeblanc
{
    class LBMenu
    {
        ...
        {
            Config = new Menu("SephLeblanc", "Leblanc", true);
            ...
            KillSteal.AddItem(new MenuItem("Killsteal.UseWWQ", "Use Extended Q", false).SetValue(true));
            KillSteal.AddItem(new MenuItem("Killsteal.UseWW", "Use Extended W", false).SetValue(true));
            KillSteal.AddItem(new MenuItem("Killsteal.UseWWE", "Use Extended E", false).SetValue(true));
            ...
            Misc.AddItem(new MenuItem("Hitchance.W", "W Hit Chance").SetValue(new StringList(new[] { HitChance.Low.ToString(), HitChance.Medium.ToString(), HitChance.High.ToString() }, 1)));
