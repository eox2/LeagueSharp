...
namespace YTSharp
{
    class Processing
    {
        ...
        internal static string DownloadAudio(IEnumerable<VideoInfo> videoInfos)
        {
            /*
        ...
        internal static void DownloadVideo(IEnumerable<VideoInfo> videoInfos)
        {
            /*
        ...
        internal static string RemoveIllegalPathCharacters(string path)
        {
